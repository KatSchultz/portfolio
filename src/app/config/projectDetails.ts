export const projects = [
  {
    ...
    description:
      "I worked for three years as a real estate photographer. When I began studying web development I made a site using HTML, CSS, and JavaScript to display my photography work. This mobile responsive site uses CSS Grid to lay out the photographs, and I created a modal to display larger photographs in a carousel.",
    githubLink: "https://github.com/KatSchultz/photography-site",
    liveLink: "https://photography-site-katschultz.vercel.app/",
  },
  {
    name: "Marge's Bar",
    description:
