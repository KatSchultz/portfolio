...
export default function NavMenu() {
  return (
    <nav className="nav-menu flex justify-center items-center w-screen h-screen absolute top-0 left-0 bg-slate-100 md:relative md:bg-transparent md:w-fit md:h-fit  ">
